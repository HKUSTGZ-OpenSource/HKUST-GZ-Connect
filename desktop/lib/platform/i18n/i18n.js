...
const dictionaries = {
  zh: {
    ...
    'engine.gatewayPreloginUnavailable': '登录前无法访问校园网关；请检查当前网络或网卡后重试',
  ...
  en: {
    ...
    'engine.gatewayPreloginUnavailable': 'The campus gateway was unavailable before login. Check the current network or adapter, then retry.',
