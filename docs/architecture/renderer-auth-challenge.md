...
- Status: Historical #117 review receipt; #118 lifecycle supersedes its facade, with no app release
...
The following records the merged structural step. Its compatibility startup is
superseded in the subsequent merged [lifecycle unit](renderer-auth-challenge-lifecycle.md), which
